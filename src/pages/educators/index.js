              ...
              <div className="row">
                {educators && educators.data && educators.data.length > 0 ? educators.data.map(item => (
                  <div className="col-lg-4">
                    <EducatorCard id={item.id} name={item.name} isAccepted={item.isAccepted} surname={item.surname} profession={item.profession} logoPath={item.profileImagePath}></EducatorCard>
                  </div>
